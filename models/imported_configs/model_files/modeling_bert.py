...
sys.path.append(os.path.join( Path(os.getcwd()).parent, 'imported_configurations'))

from model_files.modeling_utils import PreTrainedModel, prune_linear_layer
from config_files.configuration_bert import BertConfig
from helper_functions.file_utils import add_start_docstrings
# coding=utf-8
# Copyright 2018 The Google AI Language Team Authors and The HuggingFace Inc. team.
# Copyright (c) 2018, NVIDIA CORPORATION.  All rights reserved.
#
